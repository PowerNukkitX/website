...
export const HeroHome = () => {
    ...
    return (
        <section className="hero-section px-4 sm:px-6 lg:px-8 py-32 md:py-36 lg:py-89 relative">
            <div className="grid md:grid-cols-2 items-center gap-4 md:gap-8 xl:gap-20">
                ...
                <div className="inset-0 w-full h-full">
                    <Image
                        ...
                        alt="PowerNukkitX"
                        src="/cover.jpg"
                        className="w-full rounded-md object-cover shadow-md hidden md:block mx-auto"
                        layout="responsive"
                        objectFit="cover"
                    />
                </div>
